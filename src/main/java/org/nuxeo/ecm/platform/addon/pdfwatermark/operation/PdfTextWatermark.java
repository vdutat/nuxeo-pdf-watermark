 ...
 * 
 */
@Operation(id = PdfTextWatermark.ID, category = Constants.CAT_CONVERSION, label = "PDF Text Watermark", description = "Overlay a text watermark on PDF")
public class PdfTextWatermark {
    ...
    @Param(name = "font", required = false, widget = Constants.W_OPTION, values = { "Helvetica-BoldOblique", "Times-Italic", "ZapfDingbats", "Symbol",
            "Helvetica-Oblique", "Courier", "Helvetica-Bold", "Helvetica", "Courier-Oblique", "Times-BoldItalic", "Courier-Bold", "Times-Roman", "Times-Bold",
            "Courier-BoldOblique" })
     ...
     */
    public PDDocument getWatermark(String text, String font, String fontSizeTxt, String color, String angle, String alphaStr, String multiplicity)
            throws IOException {
